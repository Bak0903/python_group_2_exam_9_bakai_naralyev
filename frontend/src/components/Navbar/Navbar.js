        ...
        return <div className='App'>
            <nav className="navbar navbar-expand-lg navbar-light bg-secondary">
                <div className="container">
                    <NavLink to='/' className="navbar-brand"> Main</NavLink>
                    ...
                    <div className={(this.state.collapse ? "collapse" : "") + " navbar-collapse"}
                        ...
                        <ul className="navbar-nav mr-auto">
                            ...
                            {/*</li>*/}
                            <li className="nav-item active">
                                <NavLink to='/halls' className="nav-link"> Test</NavLink>
                            </li>
                            {is_admin === true ?
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <NavLink to='/halls/add' className="nav-link"> Добавить тест </NavLink>
                                    </li>
                                </ul> : null}
                        </ul>
